...
<div class="chat-message bot">
    <div class="avatar">
        <img src="https://www.paidmembershipspro.com/wp-content/uploads/2022/01/automatorwp-icon.png" style="max-height: 55px; max-width: 55px; border-radius: 50%; object-fit: cover;">
    </div>
...
<div class="chat-message user">
    <div class="avatar">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReeDtnaKLjD5A4wMd54A_D7XiNZEQUtzmB1tgcwuz5uyPaF8VcNZhswodqWn7-9lgRf3Q&usqp=CAU", style="max-height: 55px; max-width: 55px; border-radius: 50%; object-fit: cover;">
    </div>    
    <div class="message">{{MSG}}</div>
</div>
'''